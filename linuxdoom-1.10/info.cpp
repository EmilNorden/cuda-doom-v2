...
void  A_Light0(player_s* p, pspdef_s* def, mobj_s* m);
void A_WeaponReady(player_s* p, pspdef_s* def, mobj_s* m);
void A_Lower(player_s* p, pspdef_s* def, mobj_s* m);
void A_Raise(player_s* p, pspdef_s* def, mobj_s* m);
void A_Punch(player_s* p, pspdef_s* def, mobj_s* m);
void A_ReFire(player_s* p, pspdef_s* def, mobj_s* m);
void A_FirePistol(player_s* p, pspdef_s* def, mobj_s* m);
void A_Light1(player_s* p, pspdef_s* def, mobj_s* m);
void A_FireShotgun(player_s* p, pspdef_s* def, mobj_s* m);
void A_Light2(player_s* p, pspdef_s* def, mobj_s* m);
void A_FireShotgun2(player_s* p, pspdef_s* def, mobj_s* m);
void A_CheckReload(player_s* p, pspdef_s* def, mobj_s* m);
void A_OpenShotgun2(player_s* p, pspdef_s* def, mobj_s* m);
void A_LoadShotgun2(player_s* p, pspdef_s* def, mobj_s* m);
void A_CloseShotgun2(player_s* p, pspdef_s* def, mobj_s* m);
void A_FireCGun(player_s* p, pspdef_s* def, mobj_s* m);
void A_GunFlash(player_s* p, pspdef_s* def, mobj_s* m);
void A_FireMissile(player_s* p, pspdef_s* def, mobj_s* m);
void A_Saw(player_s* p, pspdef_s* def, mobj_s* m);
void A_FirePlasma(player_s* p, pspdef_s* def, mobj_s* m);
void A_BFGsound(player_s* p, pspdef_s* def, mobj_s* m);
void A_FireBFG(player_s* p, pspdef_s* def, mobj_s* m);
void A_BFGSpray(player_s* p, pspdef_s* def, mobj_s* m);
void A_Explode(player_s* p, pspdef_s* def, mobj_s* m);
void A_Pain(player_s* p, pspdef_s* def, mobj_s* m);
void A_PlayerScream(player_s* p, pspdef_s* def, mobj_s* m);
void A_Fall(player_s* p, pspdef_s* def, mobj_s* m);
void A_XScream(player_s* p, pspdef_s* def, mobj_s* m);
void A_Look(player_s* p, pspdef_s* def, mobj_s* m);
void A_Chase(player_s* p, pspdef_s* def, mobj_s* m);
void A_FaceTarget(player_s* p, pspdef_s* def, mobj_s* m);
void A_PosAttack(player_s* p, pspdef_s* def, mobj_s* m);
void A_Scream(player_s* p, pspdef_s* def, mobj_s* m);
void A_SPosAttack(player_s* p, pspdef_s* def, mobj_s* m);
void A_VileChase(player_s* p, pspdef_s* def, mobj_s* m);
void A_VileStart(player_s* p, pspdef_s* def, mobj_s* m);
void A_VileTarget(player_s* p, pspdef_s* def, mobj_s* m);
void A_VileAttack(player_s* p, pspdef_s* def, mobj_s* m);
void A_StartFire(player_s* p, pspdef_s* def, mobj_s* m);
void A_Fire(player_s* p, pspdef_s* def, mobj_s* m);
void A_FireCrackle(player_s* p, pspdef_s* def, mobj_s* m);
void A_Tracer(player_s* p, pspdef_s* def, mobj_s* m);
void A_SkelWhoosh(player_s* p, pspdef_s* def, mobj_s* m);
void A_SkelFist(player_s* p, pspdef_s* def, mobj_s* m);
void A_SkelMissile(player_s* p, pspdef_s* def, mobj_s* m);
void A_FatRaise(player_s* p, pspdef_s* def, mobj_s* m);
void A_FatAttack1(player_s* p, pspdef_s* def, mobj_s* m);
void A_FatAttack2(player_s* p, pspdef_s* def, mobj_s* m);
void A_FatAttack3(player_s* p, pspdef_s* def, mobj_s* m);
void A_BossDeath(player_s* p, pspdef_s* def, mobj_s* m);
void A_CPosAttack(player_s* p, pspdef_s* def, mobj_s* m);
void A_CPosRefire(player_s* p, pspdef_s* def, mobj_s* m);
void A_TroopAttack(player_s* p, pspdef_s* def, mobj_s* m);
void A_SargAttack(player_s* p, pspdef_s* def, mobj_s* m);
void A_HeadAttack(player_s* p, pspdef_s* def, mobj_s* m);
void A_BruisAttack(player_s* p, pspdef_s* def, mobj_s* m);
void A_SkullAttack(player_s* p, pspdef_s* def, mobj_s* m);
void A_Metal(player_s* p, pspdef_s* def, mobj_s* m);
void A_SpidRefire(player_s* p, pspdef_s* def, mobj_s* m);
void A_BabyMetal(player_s* p, pspdef_s* def, mobj_s* m);
void A_BspiAttack(player_s* p, pspdef_s* def, mobj_s* m);
void A_Hoof(player_s* p, pspdef_s* def, mobj_s* m);
void A_CyberAttack(player_s* p, pspdef_s* def, mobj_s* m);
void A_PainAttack(player_s* p, pspdef_s* def, mobj_s* m);
void A_PainDie(player_s* p, pspdef_s* def, mobj_s* m);
void A_KeenDie(player_s* p, pspdef_s* def, mobj_s* m);
void A_BrainPain(player_s* p, pspdef_s* def, mobj_s* m);
void A_BrainScream(player_s* p, pspdef_s* def, mobj_s* m);
void A_BrainDie(player_s* p, pspdef_s* def, mobj_s* m);
void A_BrainAwake(player_s* p, pspdef_s* def, mobj_s* m);
void A_BrainSpit(player_s* p, pspdef_s* def, mobj_s* m);
void A_SpawnSound(player_s* p, pspdef_s* def, mobj_s* m);
void A_SpawnFly(player_s* p, pspdef_s* def, mobj_s* m);
void A_BrainExplode(player_s* p, pspdef_s* def, mobj_s* m);
...
state_t	states[NUMSTATES] = {
    ...
    {SPR_PLAY,16,5,{A_Fall},S_PLAY_XDIE4,0,0},	// S_PLAY_XDIE3/home/emil/code/DOOM/linuxdoom-1.10/info.cpp:1103:1: error: invalid conversion from ‘void (*)()’ to ‘actionf_p3’ {aka ‘void (*)(player*, pspdef*, mobj*)’} [-fpermissive]
