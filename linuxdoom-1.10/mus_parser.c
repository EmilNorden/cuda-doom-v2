...
mus_file_t *mus_parse(void *mem, int length) {
    mus_file_t *result = malloc(sizeof(mus_file_t));
    ...
    result->instruments = malloc(sizeof(uint16_t) * result->instrument_count);
    ...
    mus_event_t *events = malloc(sizeof(mus_event_t) * event_capacity);
    ...
    while (bin_has_more_data(&reader)) {
        if (event_count == event_capacity) {
            event_capacity *= 2;
            events = realloc(events, sizeof(mus_event_t) * event_capacity);
        }
        ...
        event->type = (event_descriptor & 0b01110000) >> 4;
        ...
        switch (event->type) {
            case release_note: {
                ...
                event->release_note = malloc(sizeof(mus_event_release_note_t));
            ...
            case play_note: {
                ...
                event->play_note = malloc(sizeof(mus_event_play_note_t));
            ...
            case pitch_bend: {
                ...
                event->pitch_bend = malloc(sizeof(mus_event_pitch_bend_t));
            ...
            case system_event: {
                ...
                event->system = malloc(sizeof(mus_event_system_t));
            ...
            case change_controller: {
                ...
                event->controller = malloc(sizeof(mus_event_change_controller_t));
