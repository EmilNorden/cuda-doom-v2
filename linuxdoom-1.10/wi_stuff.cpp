...
void WI_slamBackground(void) {
    memcpy(pixels[0], pixels[1], SCREENWIDTH * SCREENHEIGHT);
...
void WI_drawStats(void) {
    ...
    V_DrawPatch(SP_TIMEX, SP_TIMEY, FB, level_time);
...
void WI_loadData(void) {
    ...
    // "time"
    level_time = (patch_t*)W_CacheLumpName("WITIME", PU_STATIC);
...
void WI_unloadData(void) {
    ...
    Z_ChangeTag(level_time, PU_CACHE);
