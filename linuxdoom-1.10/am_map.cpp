...
mline_t triangle_guy[] = {
        {{static_cast<fixed_t>(-.867 * R), static_cast<fixed_t>(-.5 * R)}, {static_cast<fixed_t>(.867 *
                                                                                                 R),         static_cast<fixed_t>(
                                                                                                                     -.5 *
                                                                                                                     R)}},
        {{static_cast<fixed_t>(.867 * R),  static_cast<fixed_t>(-.5 * R)}, {0, R}},
        {{0, R},                                                           {static_cast<fixed_t>(-.867 *
                                                                                                 R),         static_cast<fixed_t>(
                                                                                                                     -.5 *
                                                                                                                     R)}}
};
...
mline_t thintriangle_guy[] = {
        ...
        {{R,                             0},                             {static_cast<fixed_t>(-.5 *
                                                                                               R),       static_cast<fixed_t>(
                                                                                                                 .7 *
                                                                                                                 R)}},
        {{static_cast<fixed_t>(-.5 * R), static_cast<fixed_t>(.7 * R)},  {static_cast<fixed_t>(-.5 *
                                                                                               R),       static_cast<fixed_t>(
                                                                                                                 -.7 *
                                                                                                                 R)}}
};
